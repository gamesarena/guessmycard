...
/*document.getElementById("print").innerHTML=x.val+" "+y.val+" "+z.val+" "+x1+" "+y1+" "+z1;*/
      ...
      var substart=document.getElementById("substart");
      var x1,y1,z1;
      if(x.nm==1)
      {
      	x1="Heart";
      ...
      submit.onclick=function()
      {
		...
		else if(g1==x.val || g2==y.val || g3==z.val || g4==x1 || g5==y1 || g6==z1)
		{
			document.getElementById("print").innerHTML="YOU ARE CLOSE, TRY AGAIN!!!!";
		}
		else
		{
			document.getElementById("print").innerHTML="NO MATCH, TRY AGAIN!!!";
		}
      }
